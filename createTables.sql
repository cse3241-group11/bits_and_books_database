...
( --NO FOREIGN KEYS
    ...
    PRIMARY KEY(ISBN), CHECK(length(ISBN) BETWEEN 10 and 13)
);
--alexxxxxxx
...
(
    ...
    FOREIGN KEY(ISBN) REFERENCES BOOK(ISBN), CHECK(length(ISBN) BETWEEN 10 and 13)
);
...
CREATE TABLE PUBLISHER -- CSV DONE
(--NO FOREIGN KEYS
...
(
    ...
    UNIQUE(Customer_ID, ISBN), CHECK(length(ISBN) BETWEEN 10 and 13)
);
...
(
    ...
    FOREIGN KEY(ISBN) REFERENCES BOOK(ISBN),
    FOREIGN KEY(Author_ID) REFERENCES AUTHOR(Author_ID), CHECK(length(ISBN) BETWEEN 10 and 13)
);
...
(
    ...
    FOREIGN KEY(ISBN) REFERENCES BOOK(ISBN),
    FOREIGN KEY(Publisher_ID) REFERENCES PUBLISHER(Publisher_ID), CHECK(length(ISBN) BETWEEN 10 and 13)
);
...
(
    ...
    FOREIGN KEY(ISBN) REFERENCES BOOK(ISBN),
    UNIQUE(Administrator_SSN, Publisher_ID, ISBN), CHECK(length(ISBN) BETWEEN 10 and 13)
);
